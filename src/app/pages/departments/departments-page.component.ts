...
export class DepartmentsPageComponent {
  ...
  readonly structureLeadershipMembers: StructureMember[] = [
    {
      name: "TS. Lê Xuân Việt",
      position: "Trưởng Khoa",
      duty: "Phụ trách, quản lý khoa CNTT",
      phone: "0905.532296",
      email: "lexuanviet@qnu.edu.vn",
    },
    {
      name: "TS. Hồ Văn Lâm",
      position: "Phó trưởng Khoa",
      duty: "Công tác chuyên môn và Nghiên cứu khoa học",
      phone: "0919.391719",
      email: "hovanlam@qnu.edu.vn",
    },
    {
      name: "TS. Nguyễn Thanh Bình",
      position: "Bí thư Chi bộ, Phó trưởng Khoa",
      duty: "Công tác sinh viên, cơ sở vật chất và Quan hệ doanh nghiệp",
      phone: "0983.331601",
      email: "nguyenbinh@qnu.edu.vn",
    },
  ];

  readonly structureAssistantMembers: StructureMember[] = [
    {
      name: "CN. Lê Thị Thanh Hoa",
      position: "Chuyên viên",
      phone: "0934.944.455",
      email: "lethithanhhoa@qnu.edu.vn",
    },
    {
      name: "ThS. Võ Thị Ngọc Hiền",
      position: "Chuyên viên",
      phone: "0905.876898",
      email: "vothingochien@qnu.edu.vn",
    },
  ];
  ...
  readonly facilityGallery: FacilityImage[] = [
    {
      src: "/phong-thccnpm.jpg",
      alt: "Phong thuc hanh chuyen nganh Cong nghe phan mem",
      caption:
        "Phòng thực hành chuyên ngành Công nghệ phần mềm, Kỹ thuật phần mềm",
    },
    {
      src: "/phong-tjdc.jpg",
      alt: "Phong thuc hanh chuyen nganh He thong thong tin",
      caption: "Phòng thực hành chuyên ngành Hệ thống thông tin",
    },
    {
      src: "/phong-thmmt.jpg",
      alt: "Phong thuc hanh ve Mang may tinh",
      caption: "Phòng thực hành về Mạng máy tính",
    },
    {
      src: "/nhom-nghien-cuu-xu-ly-ngon-ngu.jpg",
      alt: "Nhom nghien cuu xu ly ngon ngu",
      caption: "Nhóm nghiên cứu về Xử lý ngôn ngữ tự nhiên",
    },
  ];
  ...
  readonly facultyPages = signal<FacultyPage[]>([
    {
      ...
      summary:
        "Thông tin chức năng và nhiệm vụ của Khoa Công nghệ thông tin, Trường Đại học Quy Nhơn.",
      ...
      sections: [
        {
          title: "Chức năng",
          body:
            "Khoa có chức năng xây dựng kế hoạch, tổ chức triển khai các hoạt động giáo dục đào tạo và nghiên cứu khoa học do khoa quản lý; xây dựng và phát triển đội ngũ giảng viên, quản lý, đánh giá viên chức và người học thuộc khoa quản lý theo sự phân cấp của Hiệu trưởng.",
        },
        {
          title: "Nhiệm vụ",
        },
        {
          title: "1. Công tác giáo dục đào tạo",
          items: [
            "a) Xây dựng chương trình, kế hoạch đào tạo, tổ chức quá trình đào tạo, đánh giá và cập nhật chương trình đào tạo các trình độ đại học, thạc sĩ, tiến sĩ cho các ngành, chuyên ngành do khoa quản lý, các ngành liên quan và các hoạt động giáo dục đào tạo khác trong Nhà trường;",
            "b) Bồi dưỡng, cập nhật, nâng cao kiến thức, năng lực chuyên môn thông qua các hoạt động giáo dục thường xuyên nhằm đáp ứng nhu cầu xã hội và nhu cầu học tập suốt đời của người học;",
            "c) Xây dựng kế hoạch thực hành, thực tập, thực tế, thực nghiệm khoa học cho người học;",
            "d) Xây dựng kế hoạch mở ngành, chuyên ngành đào tạo; xây dựng kế hoạch bảo đảm chất lượng chương trình đào tạo;",
            "đ) Phối hợp với Phòng Khảo thí và Bảo đảm chất lượng, Phòng Đào tạo đại học và Phòng Đào tạo sau đại học trong việc tổ chức thi học phần, thi tốt nghiệp; phối hợp với Phòng Khảo thí và Bảo đảm chất lượng trong công tác đánh giá chất lượng giáo dục;",
            "e) Phối hợp với các khoa, phòng liên quan trong việc xây dựng kế hoạch và tổ chức triển khai đào tạo và cấp Chứng chỉ Giáo dục quốc phòng - an ninh, Chứng chỉ ngoại ngữ, Chứng chỉ công nghệ thông tin và các chứng chỉ khác cho người học;",
            "g) Quản lý, theo dõi người học theo Quy chế của Bộ Giáo dục và Đào tạo và quy định của Trường; thông báo kịp thời kết quả học tập cho sinh viên; phát hiện và bồi dưỡng nhân tài; phối hợp với phòng Công tác chính trị - Sinh viên tổ chức, triển khai các hoạt động liên quan đến người học, đánh giá kết quả rèn luyện của người học.",
            "h) Quản lý, theo dõi người học theo Quy chế của Bộ Giáo dục và Đào tạo và quy định của Trường; thông báo kịp thời kết quả học tập cho sinh viên; phát hiện và bồi dưỡng nhân tài; phối hợp với phòng Công tác chính trị - Sinh viên tổ chức, triển khai các hoạt động liên quan đến người học, đánh giá kết quả rèn luyện của người học.",
          ],
        },
        {
          title: "2. Công tác nghiên cứu khoa học",
          items: [
            "a) Xây dựng kế hoạch, tổ chức và triển khai các hoạt động khoa học và công nghệ; thực hiện các đề tài, dự án, chuyển giao công nghệ; tổ chức hội nghị, seminar và các sinh hoạt học thuật khác;",
            "b) Tổ chức biên soạn chương trình, giáo trình, tài liệu tham khảo; cải tiến phương pháp dạy học, nghiên cứu nhằm phục vụ công tác đào tạo và nghiên cứu khoa học;",
            "c) Quản lý nội dung, phương pháp, chất lượng hoạt động khoa học - công nghệ; thực hiện việc công bố công trình khoa học - công nghệ;",
            "d) Phối hợp với phòng Khoa học công nghệ và Hợp tác quốc tế tổ chức, triển khai công tác nghiên cứu khoa học trong giảng viên và sinh viên."
          ],
        },
        {
          title: "3. Các công tác khác",
          items: [
            "a) Đề xuất các giải pháp xây dựng và phát triển khoa: về tổ chức, nhân sự; phát triển đội ngũ giảng viên, cơ sở vật chất và các điều kiện đảm bảo chất lượng đào tạo đáp ứng nhu cầu xã hội và hội nhập quốc tế;",
            "b) Xây dựng kế hoạch và tổ chức công tác giáo dục chính trị, tư tưởng, đạo đức, lối sống, đời sống tinh thần cho đội ngũ viên chức và người học thuộc khoa quản lý;",
            "c) Quản lý đội ngũ viên chức của khoa theo phân cấp; tổ chức đánh giá viên chức quản lý, giảng viên và nghiên cứu viên trong khoa; tham gia đánh giá viên chức quản lý cấp trên, viên chức quản lý ngang cấp theo quy định của Nhà trường;",
            "d) Xây dựng kế hoạch và quản lý công tác đào tạo, bồi dưỡng kiến thức chuyên môn, nghiệp vụ sư phạm cho giảng viên của khoa;",
            "đ) Thực hiện các hoạt động hợp tác và đối ngoại trong phạm vi chức năng và quyền hạn của khoa;",
            "e) Quản lý, sử dụng hiệu quả các tài sản, trang thiết bị và tài chính do Trường cung cấp;",
      ...
      sections: [
        {
          title: "SỨ MỆNH",
          body:
            "Khoa Công nghệ thông tin Trường Đại học Quy Nhơn là trung tâm đào tạo đại học, sau đại học, cung cấp nguồn nhân lực chất lượng cao đáp ứng yêu cầu phát triển kinh tế - xã hội đất nước, đặc biệt là đào tạo nguồn nhân lực cho khu vực miền Trung - Tây Nguyên. Khoa cũng là đơn vị quan trọng trong nghiên cứu khoa học, phát triển ứng dụng và chuyển giao công nghệ thuộc lĩnh vực công nghệ thông tin.",
        },
        {
          title: "TẦM NHÌN",
          body:
            "Đến năm 2030, Khoa Công nghệ thông tin Trường Đại học Quy Nhơn trở thành đơn vị đào tạo và nghiên cứu khoa học uy tín của cả nước, có vai trò nòng cốt trong đào tạo, nghiên cứu, và chuyển giao các sản phẩm đào tạo về Công nghệ thông tin của Trường Đại học Quy Nhơn.",
        },
      ],
    },
    {
      ...
      metaLine: "19/11/2019",
      centerHeading:
        "KẾ HOẠCH CHIẾN LƯỢC PHÁT TRIỂN KHOA CÔNG NGHỆ THÔNG TIN GIAI ĐỌAN 2025 - 2030",
      paragraphs: [],
      highlights: [],
      sections: [
        {
        ...
        {
          title:
            "	2. PHÂN TÍCH DỰ BÁO PHÁT TRIỂN MÔI TRƯỜNG KINH TẾ - XÃ HỘI VÀ ĐÁNH GIÁ THỰC TRẠNG KHOA CÔNG NGHỆ THÔNG TIN",
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            "Giang vien va phuong phap giang day",
        ...
        },
        {
          title: "3.1. Sứ mệnh ",
          body:
            "Khoa Công nghệ thông tin Trường ĐHQN là đơn vị đào tạo đại học, sau đại học, cung cấp nguồn nhân lực trong lĩnh vực công nghệ thông tin chất lượng cao đáp ứng yêu cầu phát triển kinh tế - xã hội đất nước, đặc biệt là đào tạo nguồn nhân lực cho khu vực miền Trung- Tây Nguyên. Khoa cũng là đơn vị quan trọng trong nghiên cứu khoa học, phát triển ứng dụng và chuyển giao công nghệ thuộc lĩnh vực công nghệ thông tin.",
        },
        {
          title: "3.2. Tầm nhìn",
          body:
            "Đến năm 2030, Khoa Công nghệ thông tin Trường ĐHQN trở thành đơn vị đào tạo và nghiên cứu khoa học uy tín của cả nước, có vai trò nòng cốt trong đào tạo, nghiên cứu, và chuyển giao các sản phẩm đào tạo về CNTT của Trường ĐHQN.",
        },
        {
          title: "3.3. Hệ thống giá trị cơ bản",
          items: [
            "- Lấy người học làm trung tâm, hệ thống đào tạo và nghiên cứu khoa học được kiểm định và đảm bảo chất lượng theo chuẩn quốc gia.",
            "- Tôn trọng tài năng và cá tính sáng tạo trong nghề nghiệp của mọi người.",
            "- Chịu trách nhiệm cao trước nhà nước và cộng đồng xã hội.",
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            "Trong giai đoạn 2025 - 2030 phát triển đội ngũ được xác định là chiến lược trung tâm, là nhân tố quyết định giữ vững quy mô và nâng cao chất lượng đào tạo. Đội ngũ cán bộ, giảng viên, viên chức  phải đạt các tiêu chuẩn cơ bản sau:",
            ...
            "Xây dựng đội ngũ cán bộ, giảng viên của Khoa ngày càng lớn mạnh đạt chất lượng cao, số lượng và cơ cấu hợp lý; chú trọng vào nâng cao năng lực công tác, bản lĩnh chính trị, phẩm chất đạo đức và lương tâm nghề nghiệp. Cụ thể:",
            "Quy hoạch phát triển đội ngũ cán bộ, giảng viên đủ về số lượng, mạnh về chất lượng, đủ phẩm chất và năng lực hoàn thành tốt nhiệm vụ trong công cuộc đổi mới của ngành Giáo dục và Đào tạo, nâng cao và đảm bảo chất lượng giáo dục và đào tạo về nhân lực công nghệ thông tin cho nhu cầu xã hội",
            "Xây dựng đội ngũ giảng viên chuẩn hóa về chức danh, trình độ theo quy định của Bộ Giáo dục và Đào tạo, phấn đấu đến năm 2030 có giảng viên đạt chức danh Phó Giáo sư và trên 35% cán bộ giảng dạy đạt trình độ tiến sĩ",
            "	Xây dựng đội ngũ cán bộ quản lý có bản lĩnh chính trị vững vàng, có năng lực quản lý tốt, có tinh thần trách nhiệm cao, năng động, sáng tạo trong công việc, có uy tín và tập hợp được cán bộ, viên chức chung sức thực hiện nhiệm vụ chung.",
          ],
        },
        {
          title: "4.1.2. Giải pháp thực hiện",
          items: [
            "Nhanh chóng bồi dưỡng đội ngũ cán bộ lãnh đạo, quản lý các cấp có tư duy chiến lược và nhạy bén với sự phát triển của thời kỳ mới. Trong quy hoạch cán bộ cần tìm kiếm, phát hiện những nhân tố mới, đó là những người có lòng nhiệt huyết, có tầm nhìn. Cần nhanh chóng đưa những cán bộ trẻ khoảng 30-40 tuổi vào hàng ngũ lãnh đạo khoa.",
            "- Tuyển dụng, tăng cường đội ngũ giảng viên đảm bảo tỉ lệ sinh viên chính quy/giáo viên và giữ ổn định tỉ lệ này vào những năm tiếp theo.  ",
            "- Đào tạo và bồi dưỡng đội ngũ giảng viên đạt chuẩn. ",
            ...
            "- Đa dạng hóa các điểm đến học tập của cán bộ trẻ. Việc tiếp nhận các nền văn hóa đa dạng cũng như phương pháp nghiên cứu khoa học, giảng dạy của các nước khác nhau rất cần thiết để phát triển nhà trường. Vì vậy cần khuyến khích cán bộ trẻ đi học tập ở nhiều nước và vùng lãnh thổ khác nhau.",
            ...
            "- Tiến hành xây dựng quy hoạch đội ngũ cán bộ, công chức, viên chức từ nay đến năm 2030, trên cơ sở đó xây dựng kế hoạch đào tạo và bồi dưỡng đội ngũ cán bộ, công chức, viên chức. Khuyến khích và tạo điều kiện cho cán bộ được đào tạo, bồi dưỡng nâng cao trình độ chuyên môn, nghiệp vụ đúng với chuyên ngành, công việc đảm nhận. Chú trọng đào tạo, bồi dưỡng đội ngũ cán bộ, công chức, viên chức một cách toàn diện về chuyên môn, chính trị, ngoại ngữ, tin học, … đảm bảo cho cán bộ sẵn sàng nhận và hoàn thành nhiệm vụ được giao. Đào tạo cán bộ gắn với sử dụng và đãi ngộ cán bộ. Tăng cường nguồn lực cho công tác đào tạo, bồi dưỡng cán bộ.",
            "- Tăng cường quản lý và sử dụng có hiệu quả đội ngũ cán bộ, công chức, viên chức theo hướng nâng cao ý thức trách nhiệm, tính kỷ luật lao động, sử dụng đúng người, đúng việc. ",
            "- Thực hiện có hiệu quả việc đánh giá cán bộ, công chức. Chủ động đào thải cán bộ, công chức, viên chức không đủ tiêu chuẩn và không đáp ứng được yêu cầu công việc.",
            ...
            "- Thực hiện việc giao chỉ tiêu, kế hoạch tuyển giảng viên mới. Trên cơ sở chỉ tiêu được giao, Khoa lập kế hoạch cụ thể để Trường duyệt và chỉ đạo việc tuyển dụng giảng viên đảm bảo số lượng và chất lượng.",
            "- Thực hiện việc tạo nguồn giảng viên từ các sinh viên tốt nghiệp loại giỏi của Trường và khuyến khích tiếp nhận các ứng viên được tốt nghiệp loại giỏi tại các trường khác, ưu tiên tiếp nhận các ứng viên tốt nghiệp ở nước ngoài. Tích cực gửi các giảng viên đi đào tạo, nâng cao trình độ ở các nước tiên tiến. Xây dựng cơ chế chính sách đãi ngộ thỏa đáng để tập hợp, trọng dụng và thu hút tri thức giỏi từ mọi nơi về làm việc tại Khoa. Có chính sách quan tâm bồi dưỡng, ưu đãi đội ngũ hiện có và chủ động xây dựng phát triển đội ngũ kế cận.",
            "- Xây dựng và thực hiện đề án phát triển đội ngũ cán bộ giảng dạy trẻ. Khuyến khích và tạo điều kiện thuận lợi cho giảng viên trẻ sớm học tập, bồi dưỡng và nâng cao trình độ trong nước và ngoài nước. Có chính sách giúp đỡ các giảng viên trẻ nhanh chóng trưởng thành. Gắn nhiệm vụ giảng dạy, nghiên cứu khoa học và yêu cầu bồi dưỡng cán bộ, giảng viên.",
            ...
            "- Cụ thể hóa nhiệm vụ của các chuyên viên, nhân viên, gắn quyền lợi, trách nhiệm và khả năng thực hiện, nhiệm vụ của từng cá nhân",
            "- Xây dựng kế hoạch đào tạo, bồi dưỡng chuyên viên một cách phù hợp để nâng cao trình độ, năng lực công tác, tính chuyên nghiệp, kỷ luật lao động, ý thức trách nhiệm để có khả năng tham mưu, tác nghiệp, tổ chức và thực hiện tốt nhiệm vụ được giao.",
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            "Đổi mới chương trình đào tạo và phương pháp giảng dạy: Mục tiêu và nội dung chương trình đào tạo phải được đổi mới theo hướng hiện đại, tiếp cận với trình độ tiên tiến trong khu vực đồng thời coi trọng kỹ năng làm việc thực tế, thích ứng với nhu cầu nguồn nhân lực cho sự nghiệp phát triển kinh tế, xã hội của địa phương và của đất nước.",
            ...
            "Tăng cường năng lực quản lý, tổ chức đào tạo: Nâng cao năng lực quản lý, tổ chức đào tạo cho cán bộ quản lý, cán bộ phục vụ đào tạo. Cán bộ quản lý và phục vụ đào tạo phải nắm vững quy chế, quy định và quy trình đào tạo...",
          ],
        },
        {
          ...
          items: [
            ...
            "- Xây dựng chuẩn đầu ra bám sát mục tiêu, chi tiết và khoa học. Chương trình đào tạo phải được thiết kế để sinh viên tốt nghiệp đạt được chuẩn đầu ra. Chú trọng đào tạo ngoại ngữ, tin học và các kỹ năng mềm",
            "- Khuyến khích giảng viên giảng dạy một số môn bằng tiếng Anh để tạo môi trường năng động hơn trong tự học và hội nhập quốc tế. Tiến tới liên kết đào tạo một vài ngành với các trường đại học nước ngoài để tăng cường quan hệ hợp tác quốc tế, trao đổi kinh nghiệm đào tạo.",
            "- Sử dụng tối ưu các phương tiện kỹ thuật hiện đại, ứng dụng hiệu quả công nghệ thông tin vào giảng dạy.",
            "- Nghiên cứu tiếp nhận và vận dụng những phương pháp giảng dạy, phương pháp đào tạo hiện đại đã được áp dụng thành công ở các nước.",
            ...
            "- Chú trọng công tác bồi dưỡng kiến thức quản lý, chuyên môn nghiệp vụ  cho cán bộ quản lý và phục vụ đào tạo.",
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            "Nâng cao năng lực nghiên cứu khoa học theo hướng chuyên sâu và đẩy mạnh công tác chuyển giao công nghệ theo yêu cầu xã hội nhằm đáp ứng yêu cầu nâng cao chất lượng đào tạo.",
            "Nâng cao năng lực nghiên cứu khoa học theo hướng chuyên sâu và đẩy mạnh công tác chuyển giao công nghệ theo yêu cầu xã hội nhằm đáp ứng yêu cầu nâng cao chất lượng đào tạo.",
        ...
        },
        {
          ...
          items: [
            "- Xây dựng Quy chế hoạt động của Khoa; có các cơ chế đánh giá để ghi nhận thành tích về nghiên cứu khoa học và có các biện pháp khuyến khích về vật chất và tinh thần cho các giảng viên, học viên và sinh viên NCKH.",
            "- Hợp tác với các viện nghiên cứu, trường đại học trong nước và quốc tế để tạo sức mạnh trong các hoạt động NCKH. Thông qua các hoạt động hợp tác, các dự án, các hợp đồng nghiên cứu tìm nguồn kinh phí đầu tư.",
            "- Gắn kết hoạt động KHCN với các khoa và bộ môn khác, tạo mối liên hệ chặt chẽ giữa đào tạo và nghiên cứu, triển khai ứng dụng",
  ...
  protected toggleFaculties(event?: Event): void {
    event?.stopPropagation();
    this.activeView.set("faculties");
    this.selectedFacultyPageKey.set("mission");
    this.isFacultyMenuOpen.set(false);
  }
  ...
  protected hideFacultyMenuImmediately(): void {
    if (this.facultyMenuCloseTimer !== null) {
      window.clearTimeout(this.facultyMenuCloseTimer);
      this.facultyMenuCloseTimer = null;
    }
  ...
  protected currentFacultyPage(): FacultyPage {
    return (
      this.facultyPages().find(
        (item) => item.key === this.selectedFacultyPageKey(),
      ) ?? this.facultyPages()[0]
    );
  }
  ...
  protected pageHeaderTitle(): string {
    if (this.activeView() === "faculties") {
      return "Khoa Cong nghe thong tin";
    }

    return "Thong tin phong ban";
  }

  protected pageHeaderDescription(): string {
    if (this.activeView() === "faculties") {
      return this.currentFacultyPage().title;
    }

    return "Danh sach cac phong ban trong truong.";
  }
  ...
  protected isDocumentStylePage(): boolean {
    return [
      ...
      "structure",
      "facilities",
    ].includes(this.selectedFacultyPageKey());
  }

  protected isStructurePage(): boolean {
    return this.selectedFacultyPageKey() === "structure";
  }

  protected isFacilitiesPage(): boolean {
    return this.selectedFacultyPageKey() === "facilities";
  }
  ...
  protected getDescriptionLines(description?: string): string[] {
    if (!description) {
      return ["Thong tin dang cap nhat."];
    }
